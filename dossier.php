    ...
    <div id="templatemo_background_section_middle">
        ...
        <div id="templatemo_left_section">
                ...
                <div class="templatemo_post">
               	   ...
               	   <center>
				   <form method=POST action='dossier.php' OnSubmit='return verify(form)'  name='form'>
					<table >

					<tr><td> رقم الملف </td></tr><tr><td><input type=text name=coded></td></tr>
                    <tr><td> رقم الزبون </td></tr><tr><td>
                        <select name="num_c">					
		             <option value="">رقم الزبون</option>	
					 <?php
		            	$co=new PDO('mysql:host=localhost;dbname=site_bl','root','');
				    $req = $co->query('SELECT * FROM client');
				    while($T=$req->fetch())
                 {
				 echo '<option value="'.$T['num_c'] .'">' .$T['num_c'] . '</option>';
					...
					?>
					 ...
					 <tr><td>تاريخ تسجيل الملف </td></tr><tr><td> <input type="text" name="datec" value="****/**/**" /></td></tr>
					 <tr><td> الرقم في محكمة الاستئناف </td></tr><tr><td> <input type=text name=num_1 value="لم يسجل بعد"></td></tr>
					<tr><td> الرقم في المحكمة الابتدائية </td></tr><tr><td> <input type=text name=num_2 value="لم يسجل بعد"></td></tr>
					<tr><td> رقم المحكمة التجارية </td></tr><tr><td> <input type=text name=num_3 value="لم يسجل بعد"></td></tr>
					<tr><td> رقم المحكمة الإدارية </td></tr><tr><td> <input type=text name=num_4 value="لم يسجل بعد"></td></tr>
					<tr><td> رقم محكمة النقض </td></tr><tr><td> <input type=text name=num_5 value="لم يسجل بعد"></td></tr>
				  ...
				  <?php
				   ...
				   if(isset($_POST['r1']))
				   {
                         ...
                         $req->execute(array($_POST['coded'],$_POST['num_c'],$_POST['datec'] ,$_POST['num_1'],$_POST['num_2'] ,$_POST['num_3'],$_POST['num_5'],$_POST['num_4'] ,$_POST['dida'],$_POST['message']));
                          echo 'bian ajouter';
