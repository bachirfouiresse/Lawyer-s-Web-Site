        ...
        <div id="templatemo_left_section">
                ...
                <div class="templatemo_post">
				   ...
				   <form method=POST action='client.php'  OnSubmit='return verify(form)'  name='form'>
					<table >
					<tr><td> رقم الزبون </td></tr><tr><td><input type=text name=codec></td></tr>
                    <tr><td> اسم الزبون </td></tr><tr><td><input type=text name=nomc></td></tr>
					 <tr><td>نوع الزبون </td></tr><tr><td><select name="typec">
                                                                                     <option value="شخص طبيعي">شخص طبيعي</option>
                                                                                     <option value="شركة">شركة</option>
																					 <option value="إدارة عمومية">إدارة عمومية</option>
                                                           </select></td></tr>
					 <tr><td> البريد الالكتروني </td></tr><tr><td><input type=text name=mailc></td></tr>
					<tr><td>الهاتف </td></tr><tr><td><input type=text name=telc></td></tr>
					<tr>
				   ...
				   if(isset($_POST['r1']))
				   {
                          ...
                          $req = $co->prepare('INSERT INTO client values(?,?,?,?,?)');
                         $req->execute(array($_POST['codec'],$_POST['nomc'],$_POST['typec'] ,$_POST['mailc'],$_POST['telc']));
                          echo 'bian ajouter';
